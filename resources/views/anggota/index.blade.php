...
<form action="{{ route('anggota.search') }}" method="GET" class="mb-4">
    <div class="row g-2">
        <div class="col-md-3">
            <input type="text" name="keyword" class="form-control" placeholder="Cari nama/email/telepon" value="{{ request('keyword') }}">
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-3">
            ...
            <a href="{{ route('anggota.index') }}" class="btn btn-secondary"><i class="bi bi-x"></i> Reset</a>
        </div>
    </div>
</form>
