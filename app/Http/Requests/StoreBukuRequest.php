...
class StoreBukuRequest extends FormRequest
{
    ...
    {
        $rules = [
            'kode_buku' => ['required', 'string', 'max:20', 'unique:buku,kode_buku', 'regex:/^BK-[A-Za-z0-9\-]+$/'],
    ...
    public function messages(): array
    {
        return [
            ...
            'kode_buku.regex' => 'Format kode buku tidak valid. Harus diawali dengan "BK-" (Contoh: BK-001).',
